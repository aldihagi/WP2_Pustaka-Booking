                            ...
                            ?>
                                <tr>
                                    ...
                                    <form action="<?= base_url('pinjam/pinjamAct/' . $p['id_booking']); ?>" method="post">
                                        <td nowrap>
                                            <button type="submit" class="btn btn-sm btn-outline-info"><i class="fas fa fa-fw fa-cart-plus">Pinjam</i></button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input class="form-check-user rounded-sm" style="width:100px" type="text" name="lama" value="3">
                                            <?= form_error(); ?>
                                        </td>
                                    </form>
                                </tr>
