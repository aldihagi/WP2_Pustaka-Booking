        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('member'); ?>" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="sumbit" class="btn btn-outline-primary">Log in</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('member/daftar'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="password" name="password1" placeholder="Password">
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="password" name="password2" placeholder="Ulangi Password">
                    </div>
                    <br>
                    <hr>
                    <div class="modal-footer">
...
<!-- modal info -->
<div class="model fade" tabindex="-1" id="modalinfo" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
